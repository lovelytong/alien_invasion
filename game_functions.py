  ...
  for event in pygame.event.get():
    if event.type == pygame.QUIT:
      ...
      check_play_button(ai_settings, screen, stats, sb,
        play_button, ship, aliens, bullets, mousex, mousey)

def check_play_button(ai_settings, screen, stats, sb, play_button,
  ship, aliens, bullets, mousex, mousey):
  """在玩家单机play按钮时开始新游戏"""
  if play_button.rect.collidepoint(mousex, mousey) and not stats.game_active:
